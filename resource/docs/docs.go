...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/appctx.UserInfo"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.sendCodeBody"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "response.Code": {
            ...
            "x-enum-comments": {
                "CodeBadRequest": "请求参数错误 / 校验失败",
                "CodeConflict": "资源冲突（如邮箱已注册）",
                "CodeForbidden": "无权限",
                "CodeInternalError": "服务内部错误",
                "CodeNotFound": "资源不存在",
                "CodeServiceUnavailable": "服务不可用（熔断 / 降载）",
                "CodeTokenExpired": "Token 已过期",
                "CodeTooManyRequests": "请求过于频繁",
                "CodeUnauthorized": "未认证 / Token 无效"
            },
            "x-enum-varnames": [
                "CodeSuccess",
                "CodeBadRequest",
