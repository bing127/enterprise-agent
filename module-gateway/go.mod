module github.com/bing127/enterprise-agent/module-gateway
...
require (
	...
	github.com/cloudwego/eino v0.9.0-alpha.22 // indirect
	...
	github.com/weaviate/weaviate-go-client/v4 v4.14.3 // indirect
